final Map<String, dynamic> articleResponseJsonTest = {
  ...
  'id': 100000009135277,
  'asset_id': 100000009135277,
  'source': 'New York Times',
  'published_date': '2023-10-21',
  'updated': '2023-10-25 15:20:39',
  'section': 'U.S.',
  'subsection': 'Politics',
  'nytdsection': 'u.s.',
  'adx_keywords':
  ...
  'org_facet': ['Harvard Law School'],
  'per_facet': ['Chesebro, Kenneth', 'Trump, Donald J', 'Tribe, Laurence H'],
  'geo_facet': [],
  'media': [
    {
      'type': 'image',
...
final Map<String, dynamic> mediaMetaDataResponseJsonTest = {
  'url':
      'https://static01.nyt.com/images/2023/10/21/multimedia/21dc-chesebro-01-gkjm/21dc-chesebro-01-gkjm-mediumThreeByTwo210.jpg',
  'format': 'mediumThreeByTwo210',
  'height': 140,
...
final Map<String, dynamic> mediaResponseJsonTest = {
  'type': 'image',
  'subtype': 'photo',
  'caption':
      'Kenneth Chesebro pleaded guilty on Friday to a single felony charge of conspiracy. He had been charged with seven felonies, including one charge under Georgia’s state racketeering law.',
